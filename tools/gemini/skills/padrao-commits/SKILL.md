---
name: padrao-commits
description: Use when creating git commits - enforces Conventional Commits format with no AI references
---
...
Seguir o padrão **Conventional Commits** em todos os commits, com mensagens escritas em **português do Brasil (PT-BR)**. Nunca incluir referências a IA ou ferramentas de geração.
